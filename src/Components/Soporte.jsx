...
const Soporte = () => {
    return (
        <div id="Soporte" className="flex justify-center items-center sm:px-24 px-[26px] text-[#272727] font-gabarito pb-24 ">
            <div className="lg:mr-10 bg-[#cfe2b4] h-auto max-w-full px-7 py-7 rounded-3xl">
                <h1 className="sm:text-left text-center sm:text-[96px] text-[50px] font-bold">24 Horas de soporte</h1>
