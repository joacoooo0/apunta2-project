        ...
        <div className="font-gabarito px-12 py-20 md:px-24 md:py-36">
            <div className="flex flex-col md:flex-row justify-between items-center w-full">
                <div className='flex flex-col justify-center w-full'>
                    <h1 className="font-extrabold text-[#19240f] text-[50px] sm:text-[80px] text-pretty leading-tight dark:text-[#a6c977]">
                        Consigue los mejores apuntes universitarios
                    </h1>
                    <h4 className="font-normal text-[#19240f] text-[25px] sm:text-[40px] text-pretty leading-snug dark:text-white">
