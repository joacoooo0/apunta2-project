    ...
    return (
        <>
            <div className="text-[#272727] font-gabarito py-24">
                <div className="px-24">
                    <div className="text-center px-96 text-pretty">
                        <h2  >UN POCO SOBRE NOSOTROS</h2>
                        <h1 id="Nosotros" className="text-[60px] font-bold">Nosotros</h1>
                ...
                <div className="mt-10 md:flex px-72 pt-40">
                    <div className="mr-10">
                    ...
                    <img className="w-[600px]" src="./public/estrella.png" alt="" />
                </div>
            </div>
